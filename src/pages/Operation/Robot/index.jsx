    ...
    <Layout title="Operações">
      <Stack>
        <Card sx={{ background: 'transparent' }}>
            ...
            >
              ...
              >
                <ProgressBar
                  ...
                  height="7px"
                  percent={statusBar}
                  filledBackground="linear-gradient(0.25turn, #4BD2F1, #1097F3)"
                >
                    ...
                    {({ accomplished }) => (
                      <Stack
                        style={{
                          ...
                          height: 17,
                          borderRadius: 17,
                          background: accomplished ? '#4BD2F1' : '#999',
                          alignItems: 'center',
                    ...
                    {({ accomplished }) => (
                      <Stack
                        style={{
                          ...
                          height: 17,
                          borderRadius: 17,
                          background: accomplished ? '#1097F3' : '#999',
                          alignItems: 'center',
                          justifyContent: 'center',
                        }}
                      >
              ...
              <Stack alignItems="center" paddingTop={1}>
                ...
                {botRunning ? (
                  ...
                  <Chip label="Desligado" variant="filled" />
                )}
              </Stack>
            </Stack>
          ...
          <Scrollbars style={{ width: '100%', height: toRem(320) }}>
            <TradeTable />
          </Scrollbars>
